...
## Deploy Automático
Este repositório possui integração contínua (CI/CD) configurada com o GitHub Actions. 
Qualquer push na branch `main` executa automaticamente o deploy no servidor VPS da Contabo.
Para enviar alterações locais e atualizar o servidor com um único comando, utilize o script local:
```powershell
