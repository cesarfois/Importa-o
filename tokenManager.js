...
export const tokenManager = {
    ...
    setTokens: async (tokens) => {
        ...
        if (!process.env.NETLIFY) {
            ...
            console.log('[TokenManager] Netlify environment: keeping manual tokens in memory.');
        }
    ...
    refreshAccessToken: async () => {
        ...
        try {
            ...
            if (!process.env.NETLIFY) {
                ...
                console.log('[TokenManager] Netlify environment: keeping refreshed tokens in memory.');
            }
    ...
    loginWithServiceAccount: async () => {
        ...
        try {
            ...
            if (!process.env.NETLIFY) {
                ...
                console.log('[TokenManager] Netlify environment: keeping service account tokens in memory.');
            }
